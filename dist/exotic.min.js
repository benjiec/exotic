...
$scope.fetches+=1;exoticValues.get($http,to_fetch,observation,function(values){for(var i=0;i<to_fetch.length;i++){var sample=to_fetch[i];var value=values[i];$scope.data_by_sample[sample.id][observation.id]=value;if($scope.example_value===undefined){$scope.example_value=value;$scope.object_attrs=$scope.example_value.__attrs__.slice(0);update_attrs();}}
